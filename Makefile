...
all: main.o model.o advertisement_detector.o transformer.o video_captor.o thread_pool.o
	$(CXX) -o AdDetector main.o model.o advertisement_detector.o transformer.o video_captor.o thread_pool.o -L$(LIBS_PATH) $(LIBS)
...
clean: AdDetector.exe main.o advertisement_detector.o transformer.o 
	del AdDetector.exe main.o model.o advertisement_detector.o transformer.o video_captor.o thread_pool.o
